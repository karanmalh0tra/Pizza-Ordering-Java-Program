        ...
        do
            {
                ...
                total=total+cost;
                System.out.println("\tPress 1 to buy more BBQ Americano Pizza's.!!!");
                System.out.println("\tPress any other number to stop buying BBQ Americano Pizza's..!!!");
                i = Integer.parseInt(buff.readLine());
            }while(i==1);
            System.out.println("\tYour BBQ Americano total is: " +total);
        }
}
