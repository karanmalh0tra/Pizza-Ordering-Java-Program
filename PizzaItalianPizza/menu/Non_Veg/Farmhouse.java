        ...
        do
            {
                ...
                total=total+cost;
                System.out.println("\tPress 1 to buy more Farmhouse Pizza's.!!!");
                System.out.println("\tPress any other number to stop buying Farmhouse Pizza's..!!!");
                i = Integer.parseInt(buff.readLine());
            }while(i==1);
            System.out.println("\tYour Farmhouse total is: " +total);
        }
}
