        ...
        do
            {
                ...
                total=total+cost;
                System.out.println("\tPress 1 to buy more Margherita's.!!!");
                System.out.println("\tPress any other number to stop buying Margherita's..!!!");
                i = Integer.parseInt(buff.readLine());
            }while(i==1);
            System.out.println("\tMargherita's cost is: " +total);
        }
}
